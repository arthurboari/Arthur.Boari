...
```{r data and codes}
taylor.filtered <- read.csv(file = "Arquivos/dashboard/Taylor Swift Spotify Data filtered only Standard.csv",header = TRUE,sep = ",",dec = ".",fileEncoding = "UTF-8")
...
knitr::include_graphics("Arquivos/dashboard/Sem título.jpg")
```
