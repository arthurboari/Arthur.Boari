...
Other used packages: `flexdashboard` [@flexdashboard], `viridis` [@viridis], `ggiraph` [@ggiraph], `reactable` [@reactable], and `reactablefmtr` [@reactablefmtr].

You are able to download the datasets in [Base](https://www.kaggle.com/datasets/arthurboari/taylor-swift-spotify-data) form, as extract from the Spotify API, or in the [Final](https://www.kaggle.com/datasets/arthurboari/taylor-swift-albums-data-standard-edition-only) form used in this dashboard.
...
knitr::include_graphics("Sem titulo.jpg")
```
...
reactable::reactable(data = taylor.view,searchable = TRUE,
                     columns = list(
                       artist_name = colDef(name = "Artist"),
                       album_release_date = colDef(name = "Release date"),
                       album_release_year = colDef(name = "Year",minWidth = 50),
                       album_name = colDef(name = "Album"),
                       track_number = colDef(name = "Track n",minWidth = 80),
                       track_name = colDef(name = "Track name"),
                       duration_min = colDef(name = "Duration (min)",minWidth = 120),
                     key_mode = colDef(name = "Key"),
                     danceability = colDef(name = "Danceability",minWidth = 110),
                     energy = colDef(name = "Energy"),
                     loudness = colDef(name = "Loudness"),
                     speechiness = colDef(name = "Speechiness"),
                     acousticness = colDef(name = 'Acousticness',minWidth = 110),
                     instrumentalness = colDef(name = "Instrumentalness",minWidth = 140),
                     liveness = colDef(name = "Liveness"),
                     valence = colDef(name = "Valence"),
                     tempo = colDef(name = "Tempo")
                     ),highlight = TRUE, paginationType = "jump",bordered = TRUE,defaultColDef = colDef(align = "center",vAlign = "center")) %>% add_title("Table: Taylor Swift's Spotify Data: standard edition", align = "center", font_color = "blue")
```
