...
```
<br>
Note that the `geom` column stores the geometries and how they should be plotted. This column has `r class(Brazil$geom)`. You can find more information about this type of data [here](https://r-spatial.github.io/sf/articles/sf1.html).
...
This code was last compiled at `r Sys.Date()`